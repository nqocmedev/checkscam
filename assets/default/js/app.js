(function ($) {
    ...
    console.info('TRONGTHAO OFFICIAL');
    ...
    const handleCheckMess = function () {
        $('.description-hidden > button, .description-overlay').click(function (e) {
            e.preventDefault();

            $(this).closest('.btn-checkmess').addClass('btn-checkmess_hidden');
        });
    }
    $(function () {
        handleHeaderMobile();
